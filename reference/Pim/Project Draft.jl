...
# ╔═╡ b904005c-49ba-11ed-2f19-770b25474780
begin 
	using PlutoUI
	using DataFrames
	using RDatasets
...
# ╔═╡ 3a9136f0-9420-4cf3-aa6b-6e2be4276be6
df = CSV.read("/Users/pimbodj/Documents/CEE 492 Project Code/concrete.csv", DataFrame)

# ╔═╡ 2644c4a6-bb9b-4b74-9c49-dc944bed8fdb
rename!(df,[:cement,:blast_furnace_slag,:fly_ash,:water,:superplasticizer,:coarse_aggregate,:fine_aggregate,:age,:concrete_compressive_strength])

# ╔═╡ 96eaf555-163a-4e37-b2a1-855c4612d4fd
describe(df)

# ╔═╡ 36fa9287-4323-47a9-b369-489767d7fa79
y = Matrix(df[:, 9:end])

# ╔═╡ d04a538c-9242-4740-b4b3-ba5571f734ff
length(df.cement)

# ╔═╡ d2bcc7a4-fd83-424b-98ec-b95a1ab6650c


# ╔═╡ 6b98d11a-3679-4d53-b94f-d10b3c56a102
z = cor(Matrix(df))

# ╔═╡ 3ce83ac0-dcb3-47a8-8eb0-b6f81c2d5803
DataFrame(z, :auto)

# ╔═╡ 3d0d9c87-7910-4b8e-8034-a0cf0db0f72d
parameter_list = ["cement","blast_furnace_slag","fly_ash","water","superplasticizer","coarse_aggregate","fine_aggregate","age","concrete_compressive_strength"]

# ╔═╡ 15d2088a-417a-46bf-847e-503aec12d45f
heatmap(parameter_list,
	parameter_list,
	z,
	xrotation = 45,
	yrotation = 0,
...
# ╔═╡ 8168acc4-5aa8-4ec6-bff5-ac7e4424ff3e
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "ca9498aa27432d0831190172a21b2bc8d438e4d6"
